/* Modified poker.c to recognize royal flush, which should hold the highest rank
 */
#include <ctype.h>
#include <stdbool.h>
#include <stdio.h>
...
void analyzeHand(void) {
   ...
   * Royal flush starts at T or rank index 8
   * */
  /* check for 4-of-a-kind, 3-of-a-kind, and pairs, royals(if all the ranks are
   * greater than 10 */
...
void dumpRanks() {
  ...
  for (int i = 0; i < NUM_RANKS; i++) {
    printf("Index: %d, content: %d", i, numInRank[i]);
  }
}
