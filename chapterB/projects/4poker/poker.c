...
/* prototypes */
void readCards(void);
void analyzeHand(bool *straight, bool *flush, bool *four, bool *three, int *pairs);
void printResult(bool straight, bool flush, bool four, bool three, int pairs);
...
int main(void) {
  ...
  for (;;) {
    readCards();
    analyzeHand(&straight, &flush, &four, &three, &pairs);
    printResult(straight, flush, four, three, pairs);
  }
  return 0;
}
